...
public class DetailsCategory_Activity extends AppCompatActivity {
    RecyclerView rcv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Mydata> options =
                new FirebaseRecyclerOptions.Builder<Mydata>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Food").orderByChild("Danhmuc").equalTo("Món canh"), Mydata.class)
                        .build();
        ...
        mainAdapter.setOnItemClickListener(new My_Adapter.OnItemClickListener() {
            ...
            public void onItemClick(Mydata data) {
                DetailsCategory_Activity.this.onItemClick(data);
            }
        });
