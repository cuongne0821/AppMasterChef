...
public class Category_Xao extends AppCompatActivity {
    RecyclerView rcv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_xao);
        ...
        FirebaseRecyclerOptions<Mydata> options =
                new FirebaseRecyclerOptions.Builder<Mydata>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Food").orderByChild("Danhmuc").equalTo("Món xào"), Mydata.class)
                        .build();
        ...
        mainAdapter.setOnItemClickListener(new My_Adapter.OnItemClickListener() {
            ...
            public void onItemClick(Mydata data) {
                Category_Xao.this.onItemClick(data);
            }
        });
    ...
    public void onItemClick(Mydata data) {
        ...
        Intent intent = new Intent(Category_Xao.this, Details_Food.class);
