...
public class Category_Chay extends AppCompatActivity {
    RecyclerView rcv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Mydata> options =
                new FirebaseRecyclerOptions.Builder<Mydata>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Food").orderByChild("Danhmuc").equalTo("Món chay"), Mydata.class)
                        .build();
        ...
        mainAdapter.setOnItemClickListener(new My_Adapter.OnItemClickListener() {
            ...
            public void onItemClick(Mydata data) {
                Category_Chay.this.onItemClick(data);
            }
        });
